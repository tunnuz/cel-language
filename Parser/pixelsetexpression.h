...
#ifndef PIXELSETEXPRESSION_HH
#define PIXELSETEXPRESSION_HH

namespace CEL {


//* abstract class to maniupulate the Syntaxic tree of PixelSetExpression
class PixelSetExpression
{

public :
    PixelSetExpression()  {};
    virtual ~PixelSetExpression() {}
    
    virtual PixelSet  *render() = 0;    
 
	virtual std::ostream& print(std::ostream &os) = 0;

	friend std::ostream &operator << (std::ostream &os, PixelSetExpression &e) {
		e.print(os);
		return os;
	}
