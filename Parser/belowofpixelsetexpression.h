...
#ifndef BELOWOFPIXELSETEXPRESSION_HH
#define RIGHTOFPIXELSETEXPRESSION_HH

namespace CEL {


class BelowOfPixelSetExpression : public PixelSetExpression
{
...
public :
    BelowOfPixelSetExpression(PixelSetExpression *l, PixelSetExpression *r) : m_leftPixelSet(l), m_rightPixelSet(r) {};
    ...
    virtual PixelSet *render() {
		...
		PixelSet *result = leftPixelSet->Below( rightPixelSet );
  	...
  	std::ostream& print(std::ostream &os) {
		os << "Below(" << *m_leftPixelSet << "," << *m_rightPixelSet << ")";
		return os;
	}
