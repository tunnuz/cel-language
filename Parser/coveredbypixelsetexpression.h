...
#ifndef COVEREDBYPIXELSETEXPRESSION_HH
#define COVEREDBYPIXELSETEXPRESSION_HH

namespace CEL {


class CoveredByPixelSetExpression : public PixelSetExpression
{
...
public :
    CoveredByPixelSetExpression(PixelSetExpression *l, PixelSetExpression *r) : m_leftPixelSet(l), m_rightPixelSet(r) {};
    ...
    virtual PixelSet *render() {
		...
		PixelSet *result = leftPixelSet->CoveredBy(rightPixelSet);
	...
	std::ostream& print(std::ostream &os) {
		os << "CoveredBy(" << *m_leftPixelSet << "," << *m_rightPixelSet << ")";
		return os;
	}
