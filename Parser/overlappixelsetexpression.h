...
#ifndef OVERLAPPIXELSETEXPRESSION_HH
#define OVERLAPPIXELSETEXPRESSION_HH

namespace CEL {


class OverlapPixelSetExpression : public PixelSetExpression
{
...
public :
    OverlapPixelSetExpression(PixelSetExpression *l, PixelSetExpression *r) : m_leftPixelSet(l), m_rightPixelSet(r) {};
    ...
    virtual PixelSet* render() {
		...
		PixelSet *result = leftPixelSet->Overlap(rightPixelSet);
 	...
 	std::ostream& print(std::ostream &os) {
		os << "Overlap(" << *m_leftPixelSet << "," << *m_rightPixelSet << ")";
		return os;
	}
