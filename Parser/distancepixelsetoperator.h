...
#ifndef DISTANCEPIXELSETOPERATOR_HH
#define DISTANCEPIXELSETOPERATOR_HH

namespace CEL {


class DistancePixelSetOperator : public PixelSetOperator
{
...
public :
    DistancePixelSetOperator(PixelSetExpression *l, PixelSetExpression *r) : m_leftPixelSet(l), m_rightPixelSet(r) {};
    ...
    virtual double evaluate() {
		...
		float result = leftPixelSet->Distance( rightPixelSet );
 	...
 	std::ostream& print(std::ostream &os) {
		os << "Distance(" << *m_leftPixelSet << "," << m_rightPixelSet << ")";
		return os;
	}
