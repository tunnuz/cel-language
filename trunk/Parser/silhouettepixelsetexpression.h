...
#ifndef SILHOUETTEPSEXPRESSION_HH
#define SILHOUETTEPSEXPRESSION_HH

namespace CEL {

// standard renderer for the pixel sets...
class SilhouettePixelSetExpression : public PixelSetExpression 
{
    PixelSetExpression * m_pixelSetExpression;

public :
    SilhouettePixelSetExpression(PixelSetExpression *t) :m_pixelSetExpression(t) {};
    virtual ~SilhouettePixelSetExpression() {}
        
    virtual PixelSet *render() {

    		PixelSet *ps = m_pixelSetExpression->render();
			
			PixelSet *result = ps->Silhouette();
 	...
 	std::ostream& print(std::ostream &os) {
		os << "Silhouette(" << *m_pixelSetExpression  << ")";
		return os;
	}
};
