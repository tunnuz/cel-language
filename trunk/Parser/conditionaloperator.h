...
#ifndef CONDITIONALOPERATOR_HH
#define CONDITIONALOPERATOR_HH

namespace CEL {

/** models an if (exp1) then exp2 else exp3
    exp1, exp2 and exp3 are all stored in the vector of expressions */
...
public :
	...
	std::ostream& print(std::ostream &os) {
		os << " if (" << **begin() << ") then " << **(++begin()) << " else " << **(++(++begin()));
		return os;
	}
