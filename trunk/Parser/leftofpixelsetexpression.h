...
#ifndef LEFTOFPIXELSETEXPRESSION_HH
#define LEFTOFPIXELSETEXPRESSION_HH

namespace CEL {


class LeftOfPixelSetExpression : public PixelSetExpression
{
...
public :
    LeftOfPixelSetExpression(PixelSetExpression *l, PixelSetExpression *r) : m_leftPixelSet(l), m_rightPixelSet(r) {};
    ...
    virtual PixelSet *render() {
		...
		PixelSet *result = leftPixelSet->Left( rightPixelSet );
	...
	std::ostream& print(std::ostream &os) {
		os << "Left(" << *m_leftPixelSet << "," << *m_rightPixelSet << ")";
		return os;
	}
